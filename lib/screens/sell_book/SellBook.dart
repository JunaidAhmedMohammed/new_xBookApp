...
class SellBook extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const appTitle = 'Add Book Details';
    return Scaffold(
...
class _MyCustomFormState extends State<MyCustomForm> {
  ...
  bool validate_data() {
    ...
    if (!isNumeric(myController_price.text) ||
        double.parse(myController_price.text) <= 0) {
      Fluttertoast.showToast(
                ...
                if (validate_data()) {
                  await books
                      ...
                      .then((value) => Fluttertoast.showToast(
                            // show toast if the book is added
                            msg: "Book added!", // message
                            toastLength: Toast.LENGTH_SHORT, // length
                            gravity: ToastGravity.BOTTOM, // location
                          ))
                      .catchError((error) => Fluttertoast.showToast(
                            // show error if failed to add
